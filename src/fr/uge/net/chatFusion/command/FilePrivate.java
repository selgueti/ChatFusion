...
public record FilePrivate(String serverSrc, String loginSrc, String serverDst, String loginDst, String fileName, int nbBlocks, int blockSize, byte[] bytes) implements Frame {
